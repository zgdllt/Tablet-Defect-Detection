...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboModel.setGeometry(QtCore.QRect(10, 0, 200, 22))
        self.comboModel.setObjectName("comboModel")
        self.bnLoadModel = QtWidgets.QPushButton(self.centralWidget)
        self.bnLoadModel.setGeometry(QtCore.QRect(220, 0, 100, 22))
        ...
        # 连接加载模型按钮的点击信号
        self.bnLoadModel.clicked.connect(self.loadModel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bnLoadModel.setText(_translate("MainWindow", "加载模型"))
